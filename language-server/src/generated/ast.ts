...
export type STPAAstReference = 'ActionUCAs:action' | 'ActionUCAs:system' | 'ContConstraint:refs' | 'Edge:source' | 'Edge:target' | 'Hazard:refs' | 'HazardList:refs' | 'LossScenario:uca' | 'Responsibility:refs' | 'Resps:system' | 'SafetyConstraint:refs' | 'SystemConstraint:refs' | 'VerticalEdge:target';
